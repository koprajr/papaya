    ...
    <div class="col-xs-12 col-sm-12">
        <div class="whiteBG">
            ...
            <img class="mainSystemNavImage img-responsive hidden-md hidden-sm hidden-xs" style="width:720px;"
                 src="img/mainNavImage.jpg" usemap="#MainPicMap"/>

            <div class="row visible-md visible-sm visible-xs">
                <div class="col-md-4 col-md-offset-4">
                    <button onclick="goTo_greenhouse();" type="button" class="btn btn-lg btn-primaryGreen btn-block">
                        Greenhouse
                    </button>
                    <button type="button" class="btn btn-lg btn-primaryGreen btn-block">Energy Cabin</button>
                    <button onclick="goTo_digester();" type="button" class="btn btn-lg btn-primaryGreen btn-block">
                        Digester
                    </button>
    ...
    <div class="col-xs-12 col-sm-12">
        <div class="whiteBG">
            ...
            <map name="greenhouseMap">
                <area onclick="goTo_greenhouseWater();" shape="rect" coords="26, 59, 141, 97">
                <!-- Water System Room 1 -->
                <area onclick="goTo_greenhouseLight();" shape="rect" coords="26, 102, 141, 140">
                <!-- Lighting System Room 1 -->
                <area onclick="goTo_greenhouseTemp();" shape="rect" coords="25, 145, 139, 179">
                <!-- Temperature Control Room 1 -->
                <area onclick="goTo_greenhouseElec();" shape="rect" coords="24, 184, 140, 220">
                <!-- Electricity Room 1 -->
                <area onclick="goTo_greenhouseWater();" shape="rect" coords="213, 61, 324, 96">
                <!-- Water System Room 2 -->
                <area onclick="goTo_greenhouseLight();" shape="rect" coords="213, 103, 324, 139">
                <!-- Lighting System Room 2 -->
                <area onclick="goTo_greenhouseTemp();" shape="rect" coords="213, 144, 324, 180">
                <!-- Temperature Control Room 2 -->
                <area onclick="goTo_greenhouseWater();" shape="rect" coords="395, 60, 507, 95">
                <!-- Water System Room 3 -->
                <area onclick="goTo_greenhouseLight();" shape="rect" coords="395, 102, 508, 140">
                <!-- Lighting System Room 3 -->
                <area onclick="goTo_greenhouseTemp();" shape="rect" coords="395, 144, 508, 179">
                <!-- Temperature Control Room 3 -->
                <area onclick="goTo_greenhouseElec();" shape="rect" coords="396, 185, 507, 221">
                <!-- Electricity Room 3 -->
                <area onclick="goTo_greenhouseElec();" shape="rect" coords="432, 331, 541, 367">
                <!-- Electricity Total -->
            </map>

            <img class="mainSystemNavImage img-responsive hidden-md hidden-sm hidden-xs" style="width:581px"
                 src="img/greenhouse.png" usemap="#greenhouseMap"/>

            <div class="row visible-md visible-sm visible-xs">
                <div class="col-md-4 col-md-offset-4">
                    <button onclick="goTo_greenhouseWater();" type="button"
                            class="btn btn-lg btn-primaryGreen btn-block">Water System
                    </button>
                    <button onclick="goTo_greenhouseLight();" type="button"
                            class="btn btn-lg btn-primaryGreen btn-block">Lighting System
                    </button>
                    <button onclick="goTo_greenhouseTemp();" type="button"
                            class="btn btn-lg btn-primaryGreen btn-block">Temperature Control
                    </button>
                    <button onclick="goTo_greenhouseElec();" type="button"
                            class="btn btn-lg btn-primaryGreen btn-block">Electricity
                    </button>
                    <br>
                </div>
                <!-- /.col-md-4 .col-md-offset-4-->
...
<div id="chart-configuration-area" class="col-sm-4 reportTempCreation2" style="border-top:0px;">
    ...
    <br>
    <button type="submit" style="margin-top:25px;" class="btn btn-block btn-primaryGreen">Save Report Template
