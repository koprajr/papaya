                ...
                <div class="col-md-4 col-md-offset-4">
                    <form role="form" action="userChangePassword" method="post">
                        ...
                        <div class="form-group">
                            <input type="hidden" title="bean.username" class="form-control" id="username" value="${username}" placeholder="">
                            <label for="oldPassword">Old Password</label>
                            <input type="password" title="bean.oldPass" class="form-control" id="oldPassword" placeholder="">
                            <label for="oldPassword">New Password</label>
                            <input type="password" title="bean.newPass" class="form-control" id="newPassword1" placeholder="">
                            <label for="newPassword2">New Password (again for confirmation)</label>
                            <input type="password" title="bean.newPass2" class="form-control" id="newPassword2" placeholder="">
                        </div><!-- /.form-group-->
